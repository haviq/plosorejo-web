...
const layananKesehatan = [
  ...
  },
  {
    ...
    lokasi: 'Jl. Raya Gondanglegi (±2 km)',
    color: '#60a5fa',
    emoji: '🏥',
  },
  {
    nama: 'RSUD Kanjuruhan',
    deskripsi: 'Rumah Sakit Umum Daerah Kabupaten Malang untuk rujukan lanjutan.',
    jam: '24 jam (IGD)',
    lokasi: 'Kepanjen, Malang (±12 km)',
    color: '#f97316',
    emoji: '🏨',
  },
]
