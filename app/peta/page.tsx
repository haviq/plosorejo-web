...
import EmergencyBannerServer from '@/components/EmergencyBannerServer'
...
export default async function PetaPage() {
  ...
  return (
    <>
      {/* Merapi emergency banner — rendered at page level because the map
          canvas creates a new stacking context that can trap the global
          fixed/sticky banner in SiteShell on some browsers. */}
